---
title: Maude project and team
---

The goals of the Maude project are supporting formal executable
specification, declarative programming, and a wide range of formal
methods as means to achieve high-quality systems in areas much as:
software engineering, networks, distributed computing, bioinformatics,
and formal tool development.

## Research Interests

The members of the Maude team have research interests spanning a variety
of different fields, although all of them related to the development and
application of formal methods. In addition to the development of Maude
itself, other areas in which the members of the group are working and
applying Maude to include:
...
In addition to work on Maude\'s design and implementation, a number of
researchers from different countries collaborate closely with the Maude
